...
//using namespace::std; //HAHA! No!
// You could do using std::cout instead 

void Parse(){
  std::cout << "Hello World!"; //testing for issues
}
// download SB3 file
// unzip and read from SB3 file
// Allow rest of main.o to continue post-compile
